...
> 3 push buttons for input (Left, Right, Enter)
> 16x2 LCD screen
> Ability to check total hours worked that day
> Ability to input a target number of hours of work
> Ability to update the number of hours worked that day
